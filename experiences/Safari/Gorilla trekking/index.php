...
<div class="page-wrapper">
    ...
    <!--End Main Header -->
	<!--Page Title-->
		<section class="page-title" style="background-image:url('../../../assets/img/bg-gorilla-trekking.jpg')" style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
    	<div class="auto-container">
        	<h2 style="color: white; text-shadow: none;">Gorilla Trekking</h2>
      </div>
    </section>
    <!--End Page Title-->
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container first">
        	<ol class="bread-crumb text-center breadcrumb shadow-lg px-md-4 indigo lighten-6" style="background-color: black;">
              ...
              <li class="breadcrumb-item font-weight-bold"><a class="black-text text-uppercase" href="../"><span class="mr-md-3 mr-2">SAFARI</span></a><i class="bi bi-chevron-double-right" aria-hidden="true"></i></li>
              <li class="breadcrumb-item font-weight-bold"><label class="black-text text-uppercase active-2" href="#"><span class="mr-md-3 mr-2">Gorilla Trekking</span></label></li>
            </ol>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                	...
                	<div class="blog-single">
						...
						<div class="lower-content">
						        <ul class="post-meta">
                                    <li style="margin-right:40px"><span class="icon fa fa-arrow-right"></span><b>DURATION:</b> 5 to 7 Hours</li><br>
                                    <li style="margin-right:40px"><span class="icon fa fa-arrow-right"></span><b>ELEVATION:</b> NA</li><br>
                                    <li style="margin-right:40px"><span class="icon fa fa-arrow-right"></span><b>PACKAGE INCLUDES:</b> Virunga Mountain (a chain of volcanoes with altitudinal ranges of 3500m-4507m)</li>
                    ...
                    <em>Naming a newly born baby has been part of Rwandan culture and tradition for centuries. Given the remarkable efforts by the Government of Rwanda, through the Rwanda Development Board, and in collaboration with various conservation partners and local communities , to actively protect the Mountai n Gorillas and their habitat, the old naming century’s tradition was modelled on these species to get the national brand known as “<strong>Kwita Izina</strong>”</em></span>
									</p>
									<p class="MsoNormal">
										<img src="../../../assets/img/bg-gorilla-trekking.jpg"	style="height: 400px;" data-filename="Picture2.png">
										<span lang="en-US"  style="font-size:14.0pt;"><br></span></p><p class="MsoNormal"><span lang="en-US"  style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;font-size:14.0pt;"><br></span></p>									<p style="text-align: left;">In order to minimize disturbance to the gorillas, only eight people are permitted to visit each of the families daily, and for a period not exceeding one hour. These limits also serve to protect gorillas from the risk of exposure to human-borne diseases. Please note that only children of 15 years and older are permitted to trek gorillas. Children aged 12 and older may trek Golden monkeys, believed to be the most endangered primate in Africa. Nature walks, accompanied by and adult or parent, are available for children younger than 12 years of age.</p>
                    <p>MOUNTAIN GORILLAS FAMILIES</p>         
                    <ul>
                      <li>Sabyinyo Group – 16 members, including the biggest silverback (Guhonda) known in the entire jungle.</li>
                      <li>Amahoro Group – 18 members including four silverbacks</li>
                      <li>Susa Group – 18 members including three silverbacks</li>
                      <li>Sabyinyo Group – 16 members</li>
                      <li>Amahoro Group – 18 members including four silverbacks</li>
                      <li>Umubano Group – 12 members including four&nbsp; silverbacks</li>
                      <li>Agashya Group – 21 members including one silverback</li>
                      <li>Hirwa Group – 18 members including one silverback</li>
                      <li>Kwitonda Group – 29 members including two&nbsp; silverbacks</li>
                      <li>Muhoza Group – 7 members including one silverback</li>
                      <li>Isabukuru Group – 14 members including one&nbsp; silverback</li>
                      <li>Mafunzo Group – 12 members including one&nbsp; silverback</li>
                      <li>Igisha Group – 25 members including three silverbacks</li>
                      <li>Karisimbi Group – 10 members including five silverbacks</li>
                      <li>Isimbi Group – 16 members including one silverback</li>
                      <li></li>
                      </ul>
                  </div>
                                <!--post-share-options-->
							...
							<div class="sidebar-widget search-box">
								<form method="post" action="#">
                                        ...
                                        <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" value="Gorilla trekking" name="tour_name" placeholder="Tour Name" disabled>
                                        </div>
                                         <div class="form-group col-md-12 col-sm-6 col-xs-12">
  ...
  <section class="services-section-two" style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
      <div class="container pt-4 py-5" style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
        ...
        <div class="row row-cols-1 row-cols-md-3 align-items-md-center g-5 py-5">
          <a href="../../Wellness/Birds watching/">
            <div class="col">
        ...
        <div class="row row-cols-1 row-cols-md-3 align-items-md-center g-5 py-5">
          ...
          <a href="../Boat safari/">
            <div class="col">
              <div class="profile-card-4 text-center"><img src="../../../assets/img/bg-boat-safari.jpg" alt="Tour 2" class="card__picture-img" width="300px" height="300px">
                  <div class="profile-content">
        ...
        <div class="row row-cols-1 row-cols-md-3 align-items-md-center g-5 py-5">
          ...
          <a href="../../Wellness/Canopy walk way/">
            <div class="col">
          ...
          <a href="../../Wellness/Guided walking safaris/">
            <div class="col">
        ...
        <div class="row row-cols-1 row-cols-md-3 align-items-md-center g-5 py-5">
          <a href="../../Wellness/Nature walks/">
            <div class="col">
              <div class="profile-card-4 text-center"><img src="../../../assets/img/bg-nature-walk.jpg" alt="Tour 1" class="card__picture-img" width="300px" height="300px">
                  <div class="profile-content">
                      <div class="profile-name" style="background-color: #467758;">Nature Walks
                      </div>
                      <div class="row" style="padding: 0;margin: 0;">
                          <div class="col" style="padding: 0;margin: 0;">
                              <div class="profile-overview">
