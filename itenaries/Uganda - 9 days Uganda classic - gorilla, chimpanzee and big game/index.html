...
<div class="page-wrapper">
    ...
    <!--End Main Header -->
	<!--Page Title-->
		<section class="page-title" style="background-image:url('../../assets/img/uganda_classic.jpg')" style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
    	<div class="auto-container">
        	<h2 style="color: white; text-shadow: none;">Uganda - 9 days Uganda classic - gorilla, chimpanzee and big game</h2>
      </div>
    </section>
    <!--End Page Title-->
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container first">
        	<ol class="bread-crumb text-center breadcrumb shadow-lg px-md-4 indigo lighten-6" style="background-color: black;">
              ...
              <li class="breadcrumb-item font-weight-bold"><label class="black-text text-uppercase active-2" href="#"><span class="mr-md-3 mr-2">Uganda - 9 days Uganda classic - gorilla, chimpanzee and big game</span></label></li>
            </ol>
							...
							<div class="sidebar-widget search-box">
								<form method="post" action="#">
                                        ...
                                        <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" value="Uganda's classic - gorilla" name="tour_name" placeholder="Tour Name" disabled>
                                        </div>
                                         <div class="form-group col-md-12 col-sm-6 col-xs-12">
