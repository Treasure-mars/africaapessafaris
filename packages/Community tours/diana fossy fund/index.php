...
<div class="page-wrapper">
	...
	<header id="header" class="fixed-top">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#tours"><span>TOUR PACKAGES</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li class="dropdown"><a href="../"><span>Community Tours</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="../kigali_city_walk/">Kigali city walk</a></li>
                  <li><a href="../karisoke research center/">Karisoke research center</a></li>
                  <li><a href="../diana fossy fund/">Diana fossy fund</a></li>
                  <li><a href="../traditional culture/">Traditional culture</a></li>
                  <li><a href="../poetry making/">Poetry making</a></li>
                  <li><a href="../ibyi wacu village/">Ibyi wacu village</a></li>
                </ul>
              </li>
              <li class="dropdown"><a href="../../Adventure tours/"><span>Adventure Tours</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="../../Adventure tours/hiking/">Hiking</a></li>
                  <li><a href="../../Adventure tours/biking/">Biking</a></li>
                  <li><a href="../../Adventure tours/cycling/">Cycling</a></li>
                </ul>
              </li>
              <li class="dropdown"><a href="../../Agrotourism experience/"><span>Agrotourism Experience</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="../../Agrotourism experience/coffee tour experience/">Coffee Tour Experience</a></li>
                  <li><a href="../../Agrotourism experience/tea tour experience/">Tea Tour Experience</a></li>
                </ul>
              </li>
              <li class="dropdown"><a href="../../heritage tours/"><span>Heritage Tours</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="../../heritage tours/ethnographic museum/">Ethnographic museum</a></li>
                  <li><a href="../../heritage tours/kings palace museum/">Kings palace museum</a></li>
                  <li><a href="../../heritage tours/environmental museum/">Environmental museum</a></li>
                  <li><a href="../../heritage tours/rwanda arts museum/">Rwanda arts museum</a></li>
                  <li><a href="../../heritage tours/richard kandt museum/">Richard kandt museum</a></li>
                </ul>
              </li>
            </ul>
          </li>
    ...
    <!--End Main Header -->
	<!--Page Title-->
		<section class="page-title" style="background-image:url('../../../assets/img/dian-fossey-tomb.jpg')" style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
    	<div class="auto-container">
        	<h2 style="color: white; text-shadow: none;">Diana Fossy Fund</h2>
      </div>
    </section>
    <!--End Page Title-->
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container first">
        	<ol class="bread-crumb text-center breadcrumb shadow-lg px-md-4 indigo lighten-6" style="background-color: black;">
            	<li class="breadcrumb-item font-weight-bold " ><a class="black-text text-uppercase  " href="../../"><span class="mr-md-3 mr-2">PACKAGES</span></a><i class="bi bi-chevron-double-right" aria-hidden="true"></i></li>
              <li class="breadcrumb-item font-weight-bold"><a class="black-text text-uppercase" href="../"><span class="mr-md-3 mr-2">COMMUNITY TOURS</span></a><i class="bi bi-chevron-double-right" aria-hidden="true"></i></li>
              <li class="breadcrumb-item font-weight-bold"><label class="black-text text-uppercase active-2" href="#"><span class="mr-md-3 mr-2">Diana Fossy Fund</span></label></li>
            </ol>
                	...
                	<div class="blog-single">
						...
						<div class="lower-content">
						        <ul class="post-meta">
                                    ...
                                    <li style="margin-right:40px"><span class="icon fa fa-arrow-right"></span><b>PACKAGE INCLUDES:</b> Diana Fossy Fund, Kigali Genocide memorial, Richard  Kandt Museum and Mount Kigali.</li>
							...
							<div class="sidebar-widget search-box">
								<form method="post" action="#">
                                        ...
                                        <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                            ...
                                            <input type="text" value="Diana Fossy Fund" name="tour_name" placeholder="Tour Name" disabled>
                                        </div>
                                         <div class="form-group col-md-12 col-sm-6 col-xs-12">
        ...
        <div class="row clearfix py-5">
          ...
          <div class="service-block-three col-lg-4 col-md-6 col-sm-12">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
              <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1 container_foto">
                <img src="../../../assets/img/karisoke.png" alt="" width="300px" height="300px">
                <article class="text-left lh-1 fw-bold" style="position: absolute;bottom:0px;">
                  <h5>KARISOKE RESEARCH <br>CENTER</h5>
                  <hr style="transform: none;">
                  <h6>The Kigali Genocide Memorial, Campaign against Genocide Museum</h6>
              </article>
              <div class="ver_mas text-center">
                <a href="../karisoke research center/">READ MORE <span class="fa fa-angle-double-right"></span></a>
              </div>
              </div>
            </div>
          </div>
          ...
          <div class="service-block-three col-lg-4 col-md-6 col-sm-12">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
              ...
              <div class="ver_mas text-center">
                <a href="../kigali_city_walk/">READ MORE <span class="fa fa-angle-double-right"></span></a>
              </div>
              </div>
            </div>
          </div>
          ...
          <div class="service-block-three col-lg-4 col-md-6 col-sm-12">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
              <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1 container_foto">
                <img src="../../../assets/img/bg-local-culture.jpg" alt="" width="300px" height="300px">
                <article class="text-left lh-1 fw-bold" style="position: absolute;bottom:0px;">
                  <h5>TRADITIONAL <br>CULTURE</h5>
                  <hr style="transform: none;">
                  <h6>The Kigali Genocide Memorial, Campaign against Genocide Museum</h6>
              </article>
              <div class="ver_mas text-center">
                <a href="../traditional culture/">READ MORE <span class="fa fa-angle-double-right"></span></a>
              </div>
              </div>
            </div>
          </div>
          ...
          <div class="service-block-three col-lg-4 col-md-6 col-sm-12">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
              <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1 container_foto">
                <img src="../../../assets/img/poetry.jpg" alt="" width="300px" height="300px">
                <article class="text-left lh-1 fw-bold" style="position: absolute;bottom:0px;">
                  <h5>POETRY <br>MAKING</h5>
                  <hr style="transform: none;">
                  <h6>The Kigali Genocide Memorial, Campaign against Genocide Museum</h6>
              </article>
              <div class="ver_mas text-center">
                <a href="../poetry making/">READ MORE <span class="fa fa-angle-double-right"></span></a>
              </div>
              </div>
            </div>
          </div>
          ...
          <div class="service-block-three col-lg-4 col-md-6 col-sm-12">
            <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
              <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1 container_foto">
                <img src="../../../assets/img/Ibyiwacu.jpg" alt="" width="300px" height="300px">
                <article class="text-left lh-1 fw-bold" style="position: absolute;bottom:0px;">
                  <h5>IBY'IWACU <br>VILLAGE</h5>
                  <hr style="transform: none;">
                  <h6>The Kigali Genocide Memorial, Campaign against Genocide Museum</h6>
              </article>
              <div class="ver_mas text-center">
                <a href="../ibyi wacu village/">READ MORE <span class="fa fa-angle-double-right"></span></a>
              </div>
              </div>
            </div>
          </div>										
