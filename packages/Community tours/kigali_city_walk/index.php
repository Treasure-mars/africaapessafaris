...
<div class="page-wrapper">
	...
	<!--Page Title-->
    	...
    	<div class="auto-container">
        	<h2 style="color: white; text-shadow: none;">Kigali City Walk</h2>
      </div>
    </section>
    <!--End Page Title-->
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container first">
        	<ol class="bread-crumb text-center breadcrumb shadow-lg px-md-4 indigo lighten-6" style="background-color: black;">
              ...
              <li class="breadcrumb-item font-weight-bold"><label class="black-text text-uppercase active-2" href="#"><span class="mr-md-3 mr-2">Kigali City Walk</span></label></li>
            </ol>
