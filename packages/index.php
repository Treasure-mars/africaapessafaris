...
<div class="page-wrapper">
	...
	<header id="header" class="fixed-top">
        ...
        <ul>
          ...
          <li class="dropdown"><a href="."><span>TOUR PACKAGES</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
    ...
    <!--End Main Header -->
	<!--Page Title-->
		<section class="page-title" style="background-image:url('../assets/img/bg-packages.jpg')" style="font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;">
    	<div class="auto-container">
        	<h2 style="color: white; text-shadow: none;">PACKAGES</h2>
      </div>
    </section>
    <!--End Page Title-->
    ...
    <div class="breadcrumb-outer">
    	<div class="auto-container first">
        	<ol class="bread-crumb text-center breadcrumb shadow-lg px-md-4 indigo lighten-6" style="background-color: black;">
              ...
              <li class="breadcrumb-item font-weight-bold"><label class="black-text text-uppercase active-2" href="#"><span class="mr-md-3 mr-2">PACKAGES</span></label></li>
            </ol>
                        ...
                        <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
                          <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1 container_foto">
                           ...
                           <div class="ver_mas text-center">
                            <a href="Community tours/kigali_city_walk/">READ MORE >></a>
                          </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col">
                          <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg">
                            <div class="d-flex flex-column h-100 pb-3 text-white text-shadow-1 container_foto">
                             ...
                             <div class="ver_mas text-center">
                              <a href="kigali_city_walk/">READ MORE >></a>
                            </div>
                            </div>
                          </div>
                        </div>
